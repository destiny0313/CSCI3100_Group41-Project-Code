...
<div class="content">
    ...
    <?php  if (isset($_SESSION['username'])) : ?>
    	<p>Welcome! <strong><?php echo $_SESSION['username']; ?></strong>, what do you want to do?</p>
      ...
      <button onclick="location.href='request.php'" class="btn" name="request_link">Request</button>
      <button onclick="location.href='estimation.php'" class="btn" name="estimation_link">Estimation</button>
